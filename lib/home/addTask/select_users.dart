...
class _SelectUsersPageState extends State<SelectUsersPage>
  ...
  Widget build(BuildContext context) {
    return Consumer<CreateTaskProvider>(
      ...
      return WillPopScope(
          onWillPop: () async {
            createTaskProvider.selectedUsers = widget.selectedUsers ?? [];
                ...
                children: [
                  Padding(
                    ...
                    child: CustomButton(
                        text: 'Save',
                        onTap: () {
                          createTaskProvider.selectedUsers = selectedUsers;
                          Navigator.pop(context);
                        }),
                  ),
                ],
  ...
  Widget _body(CreateTaskProvider createTaskProvider) {
    final allUsers = createTaskProvider.users;
  ...
  Widget _header(CreateTaskProvider createTaskProvider) {
    return Stack(
