...
class _SelectUsersPageState extends State<SelectUsersPage>
        ...
        Scaffold(
          ...
          body: Consumer<UpdateTaskProvider>(
              builder: (_, UpdateTaskProvider editTaskProvider, __) {
                final users =
                editTaskProvider.users.where(containsSearchText).toList();


                return WillPopScope(
                  onWillPop: () async {
                    editTaskProvider.selectedUsers = widget.selectedUsers ?? [];
                  ...
                  child: Padding(
                    ...
                    child: Container(
                        ...
                        child: _body(editTaskProvider)

                        // editTaskProvider.isInited
            ...
            builder: (_, UpdateTaskProvider editTaskProvider, __) {
              return Column(
                ...
                Padding(
                  ...
                  child: CustomButton(
                    text: 'Save', onTap: () {
                    editTaskProvider.selectedUsers=selectedUsers;
                    Navigator.pop(context);
                  }),
                ),
              ],);
  ...
  Widget _body(UpdateTaskProvider editTaskProvider) {
    final allUsers =  editTaskProvider.users;
  ...
  Widget _header(UpdateTaskProvider editTaskProvider) {
    return Stack(
