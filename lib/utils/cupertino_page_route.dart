...
enum RouteAnimationDirection {fromRight, fromLeft}
...
class CupertinoPageRoute<T> extends PageRoute<T> {
  ...
  final RouteAnimationDirection direction;
  ...
  static Widget buildPageTransitions<T>(
    ...
    Widget child,
    RouteAnimationDirection direction,
  ) {
    if (route.fullscreenDialog) {
  ...
  Widget buildTransitions(BuildContext context, Animation<double> animation, Animation<double> secondaryAnimation, Widget child) {
    return buildPageTransitions<T>(this, context, animation, secondaryAnimation, child, direction);
  }
...
class CupertinoPageTransition extends StatelessWidget {
  ...
  CupertinoPageTransition({
    ...
    @required RouteAnimationDirection direction,
       ...
       _primaryPositionAnimation =
           (linearTransition
             ...
             direction == RouteAnimationDirection.fromRight
              ? Tween<Offset>(
                  begin: const Offset(1.0, 0.0),
                  end: Offset.zero,
                )
...
class _CupertinoBackGestureDetectorState<T> extends State<_CupertinoBackGestureDetector<T>> {
  ...
  double _convertToLogical(double value) {
    if (widget.direction == RouteAnimationDirection.fromRight) {
      return value;
    } else {
      return -value;
    }
    ...
    return Stack(
      ...
      children: <Widget>[
        ...
        PositionedDirectional(
          start: widget.direction == RouteAnimationDirection.fromRight
            ? 0
            : MediaQuery.of(context).size.width - dragAreaWidth,
          width: dragAreaWidth,
          top: 0.0,
          bottom: 0.0,
          child: Listener(
